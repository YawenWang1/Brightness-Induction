...
-i ${prfPth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}.nii.gz \
-o ${Outpth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}_reg2anat.nii.gz \
-n GenericLabel \
-r ${fixed_anat} \
...
$ANTSPATH/antsApplyTransforms -d 3 \
-i ${prfPth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}.nii.gz \
-o ${FunOutpth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}_reg2fun.nii.gz \
-n GenericLabel \
-r ${moving_fun} \
...
#
#   mri_vol2surf \
#   --mov ${Outpth}stimulus_roi_95prct_ori_reg2fsanat.nii.gz \
#   --regheader ${subjID} \
#   --hemi ${hemi} \
#   --o ${prfsrfOptPth}stimuli_roi_95prct_ori_reg2fsanat_${hemi}.nii.gz \
#   --interp nearest
# done
#
#
...
#
#   mri_vol2surf \
#   --mov ${Outpth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}_reg2fsanat.nii.gz \
#   --regheader ${subjID} \
#   --hemi ${hemi} \
#   --o ${prfsrfOptPth}pRF_results_ovrlp_mask_95prct_${prf_roi_namearray[${i}]}_reg2fsanat_${hemi}.nii.gz \
#   --interp nearest
# done
#
# done
