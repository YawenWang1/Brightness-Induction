...
export prf_roi_namearray=(1 "wm_both" "wm_gm_both" "wm_lh" "wm_rh" "pRF_50prct_background_reg2fsanat" "pRF_50prct_background_reg2fsanat_reg2run" "pRF_50prct_centre_reg2fsanat" "pRF_50prct_centre_reg2fsanat_reg2run" "pRF_50prct_edge_reg2fsanat" "pRF_50prct_edge_reg2fsanat_reg2run")
...
$ANTSPATH/ResampleImage \
3 \
${anatPth}upsampling/${prf_roi_namearray[${i}]}.nii.gz \
${anatPth}upsampling/${prf_roi_namearray[${i}]}_pt4.nii.gz \
0.4x0.4x0.4 \
0 \
1 \
6free
