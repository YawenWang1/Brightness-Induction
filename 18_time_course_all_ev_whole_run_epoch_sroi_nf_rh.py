...
meantsPth='/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/fslmeants_sroi_nf/rh/'
os.chdir(meantsPth)
...
strPathOut = '/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/ERA_sroi_nf_rh'
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
         ...
         #               # Calculate baseline before every epoch
                   ...
                   plt.title( 'rh_sub-12_sroi_nf_fun_0' + str((index_02+1)) + '_' +  \
                             ocROI[index_00] +'_'+  stiROI[index_01] + \
                              '_up_BOLD_Signal_Change')
                   plt.savefig( 'rh_sub-12_sroi_nf_fun_0' + str((index_02+1)) + '_' +  \
                             ocROI[index_00] + '_'+ stiROI[index_01] + \
         ...
         plt.title( 'rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run')
         plt.savefig( 'rh_sub-12_sroi_nf_' +ocROI[index_00] +'_'+  stiROI[index_01] + '_up_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( 'rh_sub-12_sroi_nf_' +ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.ylabel('% BOLD Signal Change')
         plt.legend(['Run1','Run2','Run3','Run4','Run5','Run6','Stimulus Block'],loc=1)
         plt.title( 'rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run')
         plt.savefig( 'rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01] + '_down_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( 'rh_sub-12_sroi_nf_' +ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.title( 'rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change')
         plt.savefig( 'rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01] + '_up_BOLD_Signal_Change.svg')
         plt.savefig('rh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change.png')
         ...
         plt.title('rh_sub-12_sroi_nf_' +  ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change')
         plt.savefig('rh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + '_down_BOLD_Signal_Change.svg')
         plt.savefig('rh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01]  + '_down_BOLD_Signal_Change.png')
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
          ...
          if not (index_00==2 & index_01==2):
              ...
              plt.ylabel('% BOLD Signal Change')
              plt.title('rh_sub-12_sroi_nf_' +ocROI[index_00] +'_'+  stiROI[index_01] + \
                          '['+str(numVoxels) +' voxels]')
              plt.savefig(sub_path+'Intermediate_steps/'+ 'rh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + \
...
#              else:
#                   axs[index_00,index_01].set_ylim([-2,4.8])
              axs[index_00,index_01].set_title('rh_sub-12_sori_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + \
                          '['+str(numVoxels) +' voxels]')

fig.legend(['Stimulus block','Zero %BOLD Change','Lum_Decre','Lum_Incre'], loc=5)
fig.suptitle('rh_sroi_nf_sub-12_ROI_Event_Related_Average',x=0.5,y=0.94,fontsize=18)
plt.savefig(sub_path+'Intermediate_steps/'+'rh_sub-12_sroi_nf_ROI_Event_Related_Average.svg')
plt.savefig(sub_path+'Intermediate_steps/'+'rh_sub-12_sroi_nf_ROI_Event_Related_Average.pdf')
plt.savefig(sub_path+'Intermediate_steps/'+'rh_sub-12_sroi_nf_ROI_Event_Related_Average.png')

      #
# plt.close('all')

np.save('sub-12_sroi_nf_rh.npy', aryBold)
