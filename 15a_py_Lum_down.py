...
This scripts was changed from ingo's script
...
data_path = '/media/h/P04/Data/S04/Ses01/03_GLM/'
## negative mask path
#neg_mask_path = data_path + 'zstat1_negativemask.nii.gz'
## load mask
#curr_contrst = nb.load(neg_mask_path)
## data _mask
#curr_contrst_data = curr_contrst.get_data().astype(np.float32)
#func_data = ['run1',
#             'run2',
#             'run3']
func_data = ['01_Func_BI/fun_01_MDC_02.feat/filtered_func_data.nii.gz',
             '01_Func_BI/fun_02_MDC_02.feat/filtered_func_data.nii.gz',
             '01_Func_BI/fun_03_MDC_02.feat/filtered_func_data.nii.gz',
             '01_Func_BI/fun_04_MDC_02.feat/filtered_func_data.nii.gz',
             '01_Func_BI/fun_05_MDC_02.feat/filtered_func_data.nii.gz',
             '01_Func_BI/fun_06_MDC_02.feat/filtered_func_data.nii.gz',
             ]


# List of 4D nii files (location within parent directory):
lstIn_01 = []
for func_id in range (0,len(func_data)):
    lstIn_01.append(data_path + func_data[func_id])
...
lstIn_02 = ['20191217_BI_7T_fMRI_Run_01_Lum_Down.txt',
            '20191217_BI_7T_fMRI_Run_02_Lum_Down.txt',
            '20191217_BI_7T_fMRI_Run_03_Lum_Down.txt',
            '20191217_BI_7T_fMRI_Run_04_Lum_Down.txt',
            '20191217_BI_7T_fMRI_Run_05_Lum_Down.txt',
            '20191217_BI_7T_fMRI_Run_06_Lum_Down.txt',]

# Output directory:
strPathOut = (data_path + '05_func_reg_averages/')
#if ~os.path.isdir(strPathOut):
#    os.mkdir(strPathOut)
# Output file name:
strOutFileName = 'P04_S03_Lum_down_410_NA.nii.gz'
...
for index_02 in range(0, varNumIn_01):
    ...
    niiTmp = nb.load(lstIn_01[index_02])
