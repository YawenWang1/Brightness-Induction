...
# non-inclusive at the end.)sub-12
tplBase = (-2, 0)
...
meantsPth='/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/fslmeants_ctnr/Twosides/'
os.chdir(meantsPth)
...
strPathOut = '/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/ERA_ctnr'
...
for runid in range(0,varNumIn_02):
     ...
     plt.savefig('fun_sub-10' + str(runid+1) + '_3EV'+'.png')
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
         ...
         for index_02 in range(0, varNumIn_02):
               ...
               varCCond = 'BS_fun_0' + str((index_02+1)) + '_' +  \
     ...
     #               # Calculate baseline before every epoch
                    varBse_up[index_03,:] = np.mean(varCCond_tc[varStr_up[index_03]:varStr_up[index_03]+3,:],axis=0)
                    varBse_down[index_03,:] = np.mean(varCCond_tc[varStr_down[index_03]:varStr_down[index_03]+3,:],axis=0)

                    var_up_perc[:,index_03*numVoxels:(index_03+1)*numVoxels]  = (np.divide(var_up[:,index_03*numVoxels:(index_03+1)*numVoxels],varBse_up[index_03,:] ) -1 ) *100
                    var_down_perc[:,index_03*numVoxels:(index_03+1)*numVoxels]  = (np.divide(var_down[:,index_03*numVoxels:(index_03+1)*numVoxels],varBse_down[index_03,:]) -1 ) *100
               ...
               plt.title( 'BS_fun_0' + str((index_02+1)) + '_ctnr_' +  \
                         ocROI[index_00] +'_'+  stiROI[index_01] + \
                          '_up_BOLD_Signal_Change')
               plt.savefig( 'BS_fun_0' + str((index_02+1)) + '_ctnr_' +  \
                         ocROI[index_00] + '_'+ stiROI[index_01] + \
         ...
         plt.title(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run')
         plt.savefig( ocROI[index_00] +'_ctnr_'+  stiROI[index_01] + '_up_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.ylabel('% BOLD Signal Change')
         plt.legend(['Run1','Run2','Run3','Run4','Run5','Run6','Stimulus Block'],loc=1)
         plt.title(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run')
         plt.savefig(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01] + '_down_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.title(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change')
         plt.savefig(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01] + '_up_BOLD_Signal_Change.svg')
         plt.savefig( ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change.png')
         ...
         plt.title(  ocROI[index_00] + '_ctnr_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change')
         plt.savefig( ocROI[index_00] +'_ctnr_'+  stiROI[index_01] + '_down_BOLD_Signal_Change.svg')
         plt.savefig( ocROI[index_00] +'_ctnr_'+  stiROI[index_01]  + '_down_BOLD_Signal_Change.png')
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
          ...
          plt.xlabel('Time/volume, TR = 2.604')
          plt.ylabel('% BOLD Signal Change')
          plt.title(ocROI[index_00] +'_ctnr_'+  stiROI[index_01] + \
                      '['+str(numVoxels) +' voxels]_BOLD_Signal_Change')
          plt.savefig(sub_path+'Intermediate_steps/'+ ocROI[index_00] +'_ctnr_'+  stiROI[index_01] + \
...
for ax in axs[2,0:2].flat:
    ax.set(xlabel='Time/volume, TR = 2.604', ylabel='% BOLD Signal Change')
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
          ...
          axs[index_00,index_01].set_ylim([-2,3.2])
...
#                   axs[index_00,index_01].set_ylim([-2,4.8])
          axs[index_00,index_01].set_title(ocROI[index_00] +'_'+  stiROI[index_01] + \
                      '['+str(numVoxels) +' voxels]_BOLD_Signal_Change')

fig.legend(['Stimulus block','Zero %BOLD Change','Lum_Decre','Lum_Incre'], loc=5)
fig.suptitle('sub-12_ctnr_ROI_Event_Related_Average',x=0.5,y=0.93)
fig.suptitle('sub-12_ctnr_ROI_Event_Related_Average',x=0.5,y=0.94,fontsize=18)
plt.savefig(sub_path+'Intermediate_steps/'+'sub-12_ctnr_ROI_Event_Related_Average.svg')
plt.savefig(sub_path+'Intermediate_steps/'+'sub-12_ctnr_ROI_Event_Related_Average.pdf')
plt.savefig(sub_path+'Intermediate_steps/'+'sub-12_ctnr_ROI_Event_Related_Average.png')

     #
plt.close('all')

np.save('sub-12_ctnr.npy', aryBold)
