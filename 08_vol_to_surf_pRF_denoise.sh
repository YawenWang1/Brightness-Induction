...
prfPth='/media/h/P04/Data/BIDS/sub-02/ses-001/func/GLM/pRF/denoise/'
...
$ANTSPATH/antsApplyTransforms -d 3 \
-i ${prfPth}results_denoise_${prf_namearray[${i}]}.nii.gz \
-o ${prfPth}results_denoise_${prf_namearray[${i}]}_reg2anat.nii.gz \
-n BSpline[4] \
-r ${fixed_anat} \
-t ${trfPth}P04_sub-02_ses-001_prf_to_fs_0GenericAffine.mat \
-v
