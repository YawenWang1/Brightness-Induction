...
-i ${prfPth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}.nii.gz \
-o ${Outpth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}_reg2anat.nii.gz \
-n GenericLabel \
-r ${fixed_anat} \
...
$ANTSPATH/antsApplyTransforms -d 3 \
-i ${prfPth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}.nii.gz \
-o ${FunOutpth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}_reg2fun.nii.gz \
-n GenericLabel \
-r ${moving_fun} \
...
$ANTSPATH/antsApplyTransforms -d 3 \
-i ${prfPth}stimulus_roi_75prct_ori.nii.gz \
-o ${Outpth}stimulus_roi_75prct_ori_reg2anat.nii.gz \
-n GenericLabel \
-r ${fixed_anat} \
-t ${trfPth}sub-02_ses-001_prf_to_ana_0GenericAffine.mat \
-v
...
$ANTSPATH/antsApplyTransforms -d 3 \
-i ${prfPth}stimulus_roi_75prct_ori.nii.gz \
-o ${FunOutpth}stimulus_roi_75prct_ori_reg2fun.nii.gz \
-n GenericLabel \
-r ${moving_fun} \
-t [${trfPth}sub-02_ses-002_fun_to_ana_0GenericAffine.mat,1] \
-t ${trfPth}sub-02_ses-001_prf_to_ana_0GenericAffine.mat \
...
#
#   mri_vol2surf \
#   --mov ${Outpth}stimulus_roi_75prct_ori_reg2fsanat.nii.gz \
#   --regheader ${subjID} \
#   --hemi ${hemi} \
#   --o ${prfsrfOptPth}stimuli_roi_75prct_ori_reg2fsanat_${hemi}.nii.gz \
#   --interp nearest
# done
#
#
...
#
#   mri_vol2surf \
#   --mov ${Outpth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}_reg2fsanat.nii.gz \
#   --regheader ${subjID} \
#   --hemi ${hemi} \
#   --o ${prfsrfOptPth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${i}]}_reg2fsanat_${hemi}.nii.gz \
#   --interp nearest
# done
#
# done
