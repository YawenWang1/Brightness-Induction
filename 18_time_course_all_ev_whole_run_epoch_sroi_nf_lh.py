...
meantsPth='/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/fslmeants_sroi_nf/lh/'
os.chdir(meantsPth)
...
strPathOut = '/media/g/P04/Data/BIDS/sub-12/ses-002/func/GLM/BI/ERA_sroi_nf_lh'
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
         ...
         if not((index_00==2 and index_01==2) or(index_00==2 and index_01==0)):
              ...
              for index_02 in range(0, varNumIn_02):
                   ...
                   varCCond = 'lh_fun_0' + str((index_02+1)) + '_' +  \
                   ...
                   # Generate epock
                   varlhe_up = np.zeros([varTmpNumBlck,numVoxels])

                   varlhe_down = np.zeros([varTmpNumBlck,numVoxels])
                   #-------------------------------------------------------------------
         ...
         #               # Calculate baseline before every epoch
                        varlhe_up[index_03,:] = np.mean(varCCond_tc[varStr_up[index_03]:varStr_up[index_03]+3,:],axis=0)
                        varlhe_down[index_03,:] = np.mean(varCCond_tc[varStr_down[index_03]:varStr_down[index_03]+3 ,:],axis=0)

                        var_up_perc[:,index_03*numVoxels:(index_03+1)*numVoxels]  = (np.divide(var_up[:,index_03*numVoxels:(index_03+1)*numVoxels],varlhe_up[index_03,:] ) -1 ) *100
                        var_down_perc[:,index_03*numVoxels:(index_03+1)*numVoxels]  = (np.divide(var_down[:,index_03*numVoxels:(index_03+1)*numVoxels],varlhe_down[index_03,:]) -1 ) *100
                   ...
                   plt.title( 'lh_fun_0' + str((index_02+1)) + '_' +  \
                             ocROI[index_00] +'_'+  stiROI[index_01] + \
                              '_up_BOLD_Signal_Change')
                   plt.savefig( 'lh_fun_0' + str((index_02+1)) + '_' +  \
                             ocROI[index_00] + '_'+ stiROI[index_01] + \
         ...
         plt.title( 'lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run')
         plt.savefig( 'lh_sub-12_sroi_nf_' +ocROI[index_00] +'_'+  stiROI[index_01] + '_up_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( 'lh_sub-12_sroi_nf_' +ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.ylabel('% BOLD Signal Change')
         plt.legend(['Run1','Run2','Run3','Run4','Run5','Run6','Stimulus Block'],loc=1)
         plt.title( 'lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run')
         plt.savefig( 'lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01] + '_down_BOLD_Signal_Change_Each_Run.svg')
         plt.savefig( 'lh_sub-12_sroi_nf_' +ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change_Each_Run.png')
         ...
         plt.title( 'lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change')
         plt.savefig( 'lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01] + '_up_BOLD_Signal_Change.svg')
         plt.savefig('lh_sub-12_sroi_nf_' + ocROI[index_00] + '_'+ stiROI[index_01]  + '_up_BOLD_Signal_Change.png')
         ...
         plt.title('lh_sub-12_sroi_nf_' +  ocROI[index_00] + '_'+ stiROI[index_01]  + '_down_BOLD_Signal_Change')
         plt.savefig('lh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + '_down_BOLD_Signal_Change.svg')
         plt.savefig('lh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01]  + '_down_BOLD_Signal_Change.png')
...
for index_00 in range(0, len(ocROI)):
    ...
    for index_01 in range(0, len(stiROI)):
          ...
          if not((index_00==2 and index_01==2) or(index_00==2 and index_01==0)):
              ...
              plt.ylabel('% BOLD Signal Change')
              plt.title('lh_sub-12_sroi_nf_' +ocROI[index_00] +'_'+  stiROI[index_01] + \
                          '['+str(numVoxels) +' voxels]')
              plt.savefig(sub_path+'Intermediate_steps/'+ 'lh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + \
...
#              else:
#                   axs[index_00,index_01].set_ylim([-2,4.8])
              axs[index_00,index_01].set_title('lh_sub-12_sroi_nf_' + ocROI[index_00] +'_'+  stiROI[index_01] + \
                          '['+str(numVoxels) +' voxels]')

fig.legend(['Stimulus block','Zero %BOLD Change','Lum_Decre','Lum_Incre'], loc=5)
fig.suptitle('lh_sub-12_sroi_nf_ROI_Event_Related_Average',x=0.5,y=0.94,fontsize=18)
plt.savefig(sub_path+'Intermediate_steps/'+'lh_sub-12_sroi_nf_ROI_Event_Related_Average.svg')
plt.savefig(sub_path+'Intermediate_steps/'+'lh_sub-12_sroi_nf_ROI_Event_Related_Average.pdf')
plt.savefig(sub_path+'Intermediate_steps/'+'lh_sub-12_sroi_nf_ROI_Event_Related_Average.png')

      #
# plt.close('all')

np.save('sub-12_sroi_nf_lh.npy', aryBold)
