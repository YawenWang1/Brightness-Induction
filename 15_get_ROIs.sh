...
for vid in {1..3}; do
  ...
  -mul ${pRF_roi_Pth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${sid}]}_reg2fsanat_msk.nii.gz \
  ${vareapth}final/sub-12_ses-002_rh_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz

  fslmaths ${vareapth}sub-12_ses-002_lh_${varea_namearray[${vid}]}.nii.gz \
  -mul ${pRF_roi_Pth}pRF_results_ovrlp_mask_75prct_${prf_roi_namearray[${sid}]}_reg2fsanat_msk.nii.gz \
  ${vareapth}final/sub-12_ses-002_lh_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz

  fslmaths ${vareapth}final/sub-12_ses-002_rh_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz \
  -add ${vareapth}final/sub-12_ses-002_lh_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz \
  ${vareapth}final/sub-12_ses-002_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz
...
for vid in {1..3}; do
  ...
  fslmaths ${vareapth}sub-12_ses-002_rh_${varea_namearray[${vid}]}.nii.gz \
  -mul ${pRF_roi_Pth}pRF_results_ovrlp_mask_50prct_${prf_roi_namearray[${sid}]}_reg2fsanat_msk.nii.gz \
  ${vareapth}final/sub-12_ses-002_rh_${varea_namearray[${vid}]}_${prf_roi_namearray[${sid}]}.nii.gz
