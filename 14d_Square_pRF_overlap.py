...
# pacman_data_path = '/media/h/P04/Data/S04/Ses01/03_GLM/03_pRF/pRF_results_up_tst/'
pacman_data_path = '/media/h/P04/Data/S04/Ses01/03_GLM/SriPlay/1Run_ss/'

# Path of nii file with x-coordinates of pRFs:
strNiiX = (pacman_data_path
           + 'results_227vol_1run_sm_hpf_x_pos_reg2anat.nii.gz')

# Path of nii file with y-coordinates of pRFs:
strNiiY = (pacman_data_path
           + 'results_227vol_1run_sm_hpf_y_pos_reg2anat.nii.gz')

# Path of nii file with pRF size estimates (SD):
strNiiSd = (pacman_data_path
            + 'results_227vol_1run_sm_hpf_SD_reg2anat.nii.gz')

# Path of nii file with R2 values:
strNiiR2 = (pacman_data_path
            + 'results_227vol_1run_sm_hpf_R2_reg2anat.nii.gz')

# Output file base name:
strNiiOt = (pacman_data_path
            + 'pRF_results_227vol_1run_sm_hpf')
