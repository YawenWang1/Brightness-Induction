...
os.chdir(TxtPthIn)
v1_center_TxtFiles=glob.glob('v1_center_' + '*_meants.txt')
v1_edge_TxtFiles=glob.glob('v1_edge_' + '*_meants.txt')
v1_background_TxtFiles=glob.glob('v1_background_' + '*_meants.txt')
...
#--------------------------------------------------------------------------
# calculate for v2
v2_TxtFiles=glob.glob('v2_center_' + '*_meants.txt')
timepoint_v2=[]
...
#--------------------------------------------------------------------------
# calculate for v3
v3_TxtFiles=glob.glob('v3_center_' + '*_meants.txt')
