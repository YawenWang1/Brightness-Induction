...
msk_brain=${anatPth}brainmask_ncrb.nii.gz
...
--output [ ${Outpth}sub-02_ses-001_prf_to_fs_,${Outpth}sub-02_ses-001_prf_to_fs_Warped.nii.gz,${Outpth}sub-02_ses-001_prf_to_fs_InverseWarped.nii.gz ] \
...
--float 1 \
--collapse-output-transforms 1 \
--output [ ${Outpth}sub-02_ses-002_fun_to_fs_,${Outpth}sub-02_ses-002_fun_to_fs_Warped.nii.gz,${Outpth}sub-02_ses-002_fun_to_fs_InverseWarped.nii.gz ] \
--interpolation BSpline[4] \
--use-histogram-matching 1 \
--winsorize-image-intensities [ 0.005,0.995 ] \
-x [ ${msk_brain}, ${msk_prf_brain} ] \
