...
#               varBse_down_perc_01[:,index_03] = (np.divide(varBse_down[:,index_03],tmpBse_down)-1)
          ...
          plt.hlines(0,0,5,linestyles="dashed")
          plt.xticks(ind)
          yerr = stats.sem(varBse_up_perc,axis=1)
          plt.errorbar(xaxis,np.mean(varBse_up_perc,axis=1), yerr=yerr, label='both limits (default)')
          ...
          yerr = stats.sem(varBse_down_perc,axis=1)
          plt.errorbar(xaxis,np.mean(varBse_down_perc,axis=1), yerr=yerr, label='both limits (default)')
