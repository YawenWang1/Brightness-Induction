...
ope_Image=sub-12_ses-001_task-pRF_acq-EP3D_dir-LR_run-1_echo-1_bold
...
FIXED=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixed.nii.gz
MASK=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixedMask_brain.nii.gz
MOVING=${ope_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-LR_run-1_echo-1_bold_MoCorr_meanTemplate.nii.gz
OUTPUT=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-LR_run-1_MoCorr_meanTemplate_T0_RL_Fixed_reg2func
OUTPUT_dc=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixed_dc_
...
fixed_Image=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixed_dc_template0.nii.gz
fixed_Msk=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixedMask_brain.nii.gz
mkdir ${fun_Pth}GLM/

OutPth="${fun_Pth}GLM/pRF/"
mkdir ${OutPth}
dcmatTrf=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixed_dc_template0GenericAffine.mat
echo ${dcmatTrf}
dcwarp=${fun_Pth}sub-12_ses-001_task-pRF_acq-EP3D_dir-RL_run-1_echo-1_bold_fixed_dc_template0warp.nii.gz
echo ${dcwarp}
...
do
  ...
  curr4dfun="${OutPth}pRF_fun_0${runid}_MoCo_Dist_Corr_Coreg.nii.gz"
  curr4dfun_srt="${OutPth}pRF_fun_0${runid}_MoCo_Dist_Corr_Coreg_srt.nii.gz"
